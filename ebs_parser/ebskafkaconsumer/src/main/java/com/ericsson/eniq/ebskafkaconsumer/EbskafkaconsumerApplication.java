package com.ericsson.eniq.ebskafkaconsumer;
...
import com.ericsson.eniq.ebskafkaconsumer.cache.TransformerCacheImpl;
import com.ericsson.eniq.parser.cache.DBLookupCache;


@SpringBootApplication
public class EbskafkaconsumerApplication implements ApplicationListener<KafkaEvent> {
	...
	public static void main(String[] args) {
		SpringApplication.run(EbskafkaconsumerApplication.class, args);
	}
	...
	public ApplicationRunner runner(KafkaListenerEndpointRegistry registry ) {
		return args -> {
			...
			registry.getListenerContainer("PM_E_EBS_FILES_GROUP").pause();
	    	...
	    	registry.getListenerContainer("PM_E_EBS_FILES_GROUP").resume();
