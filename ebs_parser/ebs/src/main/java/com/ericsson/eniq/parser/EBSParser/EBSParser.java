 ...
 * 
 */
public class EBSParser implements Callable<Boolean> {
   ...
   * Initialize parser
   */
  public EBSParser(final SourceFile sf, final String techPack,
  ...
  public void parse(final SourceFile sf, final String techPack,
    ...
    log.log(Level.INFO, "Data parsed. Parser initialization took "
