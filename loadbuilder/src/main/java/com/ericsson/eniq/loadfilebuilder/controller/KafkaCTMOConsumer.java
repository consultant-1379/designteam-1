...
@Service
public class KafkaCTMOConsumer {

	private static final Logger LOG = LogManager.getLogger(KafkaCTMOConsumer.class);
	...
	@KafkaListener(id = "CT_GROUP", topics = "CT_DATA", containerFactory = "batchFactory")
