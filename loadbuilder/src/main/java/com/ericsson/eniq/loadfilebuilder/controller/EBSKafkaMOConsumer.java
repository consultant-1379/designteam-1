...
@Service
public class EBSKafkaMOConsumer {

	private static final Logger LOG = LogManager.getLogger(EBSKafkaMOConsumer.class);
	...
	@KafkaListener(id = "PM_E_EBS_DATA_GROUP", topics = "PM_E_EBS_DATA", containerFactory = "batchFactory")
