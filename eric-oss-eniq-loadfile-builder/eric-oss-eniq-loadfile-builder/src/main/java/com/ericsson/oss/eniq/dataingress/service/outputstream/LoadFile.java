...
import com.ericsson.oss.eniq.dataingress.service.config.SpringContext;
import com.ericsson.oss.eniq.dataingress.service.model.Notification;
import com.ericsson.oss.eniq.dataingress.service.producer.ProducerService;
...
public final class LoadFile implements ILoadFile{
	...
	LoadFile (String outDir, String folderName, int THRESHOLD_NUMBER) {
	...
	public void save(GenericRecord record) {
		...
		if(count > THRESHOLD_NUMBER) {
			...
			notification.setPath(outFileName);
			notification.setTimestamp(System.currentTimeMillis());
			notification.setTableName(moName);
